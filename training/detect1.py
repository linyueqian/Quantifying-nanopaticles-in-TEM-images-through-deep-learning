...
flags.DEFINE_string('weights', './checkpoints/yolov3_train_25.tf', 'path to weights file')
...
def detect_tfrecord_batch(record_path, weights = './checkpoints/yolov3_train_25.tf', classes = './yolov3_tf2/particle.names', num_classes = 1, size = 416, tiny = False, batch_size = 12):
